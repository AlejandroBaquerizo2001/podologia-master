...
import { Envelope, Lock, ArrowRight, HeartPulse } from 'react-bootstrap-icons';
            ...
            <Card className="shadow-lg border-0 rounded-4 overflow-hidden" style={{
              ...
              <div style={{
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                  <HeartPulse className="mb-2" style={{ fontSize: '2rem', color: '#ffffff' }} />
                  <h3 className="fw-bold mb-1" style={{ color: '#ffffff', textShadow: '0 2px 4px rgba(0,0,0,0.2)' }}>Centro de Salud</h3>
                  <p className="mb-0" style={{ color: '#c2e3ff' }}>Ingrese sus credenciales de acceso</p>
                </div>
              </div>
              ...
              <Card.Body className="p-4 p-md-5" style={{ background: 'rgba(255, 255, 255, 0.95)' }}>
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  <Form.Group className="mb-4">
                    <Form.Label className="small fw-bold" style={{ color: '#2a5c8b' }}>Contraseña</Form.Label>
                    <div className="input-group" style={{ 
                      border: '1px solid #89c2f0',
                      borderRadius: '8px',
                      background: 'rgba(168, 213, 255, 0.1)'

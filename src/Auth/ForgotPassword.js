...
import { Envelope, Key, ShieldCheck, ArrowCounterclockwise } from 'react-bootstrap-icons';
...
const ForgotPassword = ({ setActiveTab }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setMessage('Se ha enviado una nueva contraseña a su correo electrónico.');
            ...
            <Card className="shadow-lg border-0 rounded-4 overflow-hidden" style={{
              ...
              <div style={{
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                  <Key className="mb-2" style={{ fontSize: '2rem', color: '#ffffff' }} />
                  <h3 className="fw-bold mb-1" style={{ color: '#ffffff', textShadow: '0 2px 4px rgba(0,0,0,0.2)' }}>Recuperar Contraseña</h3>
                  <p className="mb-0" style={{ color: '#c2e3ff' }}>Restablezca su contraseña</p>
                </div>
              </div>
              ...
              <Card.Body className="p-4 p-md-5" style={{ background: 'rgba(255, 255, 255, 0.95)' }}>
                {message ? (
                  ...
                  <>
                    <p className="mb-4 text-center" style={{ color: '#2a5c8b' }}>
                      Ingrese su dirección de correo electrónico para recibir instrucciones.
                    </p>
                    
                    <Form onSubmit={handleSubmit}>
                      <Form.Group className="mb-4">
                        <Form.Label className="small fw-bold" style={{ color: '#2a5c8b' }}>Correo Electrónico Asociado</Form.Label>
                      ...
                      >
                        {isLoading ? 'Enviando...' : (
                          <>
                            Recuperar <ArrowCounterclockwise className="ms-2" />
                          </>
                        )}
                      </Button>
                    </Form>
                ...
                <div className="text-center mt-4">
                  <Button 
                    ...
                    style={{ color: '#4a9fea' }}
                  >
                    <ArrowCounterclockwise className="me-1" /> Volver al inicio de sesión
                  </Button>
                </div>
              </Card.Body>
              ...
              <div className="py-3 text-center" style={{ 
                ...
                <p className="mb-0 small" style={{ color: '#2a5c8b' }}>
                  ¿Requiere asistencia? <Button variant="link" className="text-decoration-none p-0 small" style={{ color: '#4a9fea' }}>Contactar con Soporte Técnico</Button>
                </p>
              </div>
            </Card>
          </Col>
